...
API_KEY = { "popular": "c385201585ff6ce14c0c89c75dd25c8e:0:72311686",
            "article": "73dc7415acb2e7a239a258a430361522:17:72311686"}
    ...
    for article in data:
        ...
        if "media" in article:
            for media in article["media"]:
                for mm in media["media-metadata"]:
...
def save_file(kind, period):
    ...
    num_results = 40# data["num_results"]
    full_data = []
...
def test():
    save_file("viewed", 7)
    titles, urls, = article_overview("viewed", 7)
    print titles
    print urls
